  ...
  return (
    <div className="flex justify-between items-centerx">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <span className="md:text-lg font-medium text-gray-dark hover:text-black">
            Log In
          </span>
        </Link>
        <Link
          href={authRoutes.register}
          className="bg-black hover:shadow-md hover:bg-gray-dark border-2 border-black text-white md:mr-0 cursor-pointer w-max h-max py-2 px-4 md:px-4 rounded md:text-lg font-medium"
        >
          Sign Up
        </Link>
      </div>
